...
-- Future Turso forward migrations continue after 024.
...
-- OBJECT table autonomy_executions (schema 24)
...
-- OBJECT index uq_autonomy_execution_active_dedupe
